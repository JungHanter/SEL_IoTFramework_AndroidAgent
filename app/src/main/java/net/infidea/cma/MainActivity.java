...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.settingBt).setOnClickListener(this);
        findViewById(R.id.aboutBt).setOnClickListener(this);
        findViewById(R.id.cancelDisplayingContextInfoBt).setOnClickListener(this);
	...
	private void setSettingInformation() {
    	...
    	if(SettingActivity.isTransmissionAvailable()) {
    		serverAddressTv.setText(session.getString("serverAddr", "null"));
